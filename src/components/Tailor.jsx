...
const Card = ({ src, title, desc , ...rest }) => (
    <div {...rest} className=' flex justify-center items-center flex-col gap-3 max-w-[350px] bg-[#f2f2f2] p-5 rounded-lg' >
...
const Tailor = () => {
  ...
  return (
    <div className='w-full mt-14 px-10 py-24 bg-[#f8f8f8] text-center' >
        <p data-aos="zoom-in" data-aos-duration="3000" className='text-4xl md:text-5xl font-bold leading-normal ' >Tailored Programs to Meet Your <br className='hidden sm:block' /> Needs</p>
      <div className="max-w-[1300px] mt-14 mx-auto flex flex-col lg:flex-row items-center lg:items-start  justify-between gap-10">
        <Card data-aos-duration="2000" data-aos="fade-down" title={'Career Transition Support'} 
        ...
        <Card data-aos-duration="2000" data-aos="fade-up" title={'Certification Training'} 
        ...
        <Card data-aos-duration="2000" data-aos="fade-down" title={'On-the-job guidance'} 
